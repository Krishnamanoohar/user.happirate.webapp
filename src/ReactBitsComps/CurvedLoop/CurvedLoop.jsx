...
const CurvedLoop = ({
  ...
  const text = useMemo(() => marqueeText);
  ...
  return (
    ...
    >
      <svg
        className="select-none w-full overflow-visible block aspect-[150/12] text-[5rem] font-bold tracking-[5px] uppercase leading-none"
        viewBox="10 -20 1440 60"
      >
        <text
          ref={measureRef}
          xmlSpace="preserve"
