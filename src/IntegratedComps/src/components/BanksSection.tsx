...
`}</style>;
  ...
  const filteredBanks = banks
    ...
    .sort((a, b) => {
      ...
      if (sortBy === "amount")
        return (
          parseInt(b.maxAmount.replace(/[^0-9]/g, "")) -
          parseInt(a.maxAmount.replace(/[^0-9]/g, ""))
        );
      if (sortBy === "fee")
        return (
          parseFloat(a.processingFee.replace(/[^0-9.]/g, "")) -
          parseFloat(b.processingFee.replace(/[^0-9.]/g, ""))
        );

      if (sortBy === "tenure")
        return (
          parseInt(b.tenure.replace(/[^0-9]/g, "")) -
          parseInt(a.tenure.replace(/[^0-9]/g, ""))
        );
      return 0;
    });
        ...
        >
          <div>
            ...
            <p className="text-slate-600 mt-2 max-w-xl">
              Find the best loan offers from India's top banks and financial
              institutions
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Select value={sortBy} onValueChange={setSortBy}>
              ...
              <SelectContent>
                ...
                <SelectItem value="fee">Lowest Processing Fee</SelectItem>
                <SelectItem value="tenure">Longest Tenure</SelectItem>
              </SelectContent>
            </Select>
            <Button
            ...
            {filteredBanks.length > 0 ? (
                  ...
                  <div className="bg-white rounded-3xl p-6 shadow-lg shadow-slate-200/50 hover:shadow-xl hover:shadow-indigo-200/50 transition-all duration-300 hover:-translate-y-1 h-full flex flex-col">
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-3">
                        <div
                          className={`w-12 h-12 rounded-xl bg-gradient-to-br ${bank.color} flex items-center justify-center text-white font-bold text-lg shadow-lg`}
                        >
                          {bank.logo}
                        </div>
                        <div>
                    ...
                    <Button
                      ...
                      className="w-full gradient-bg text-white font-semibold py-5 rounded-xl hover:shadow-lg hover:shadow-indigo-500/30 transition-all duration-300 group"
                    >
                      Apply Now
              ...
              <div className="w-full flex flex-col items-center justify-center py-12 text-center animate-in fade-in zoom-in duration-300">
                ...
                <p className="text-slate-500 max-w-md mx-auto">
                  We couldn't find any partner banks matching your search. Try
                  adjusting your filters or search for another bank.
                </p>
                <Button
                  variant="link"
                  onClick={() => {
