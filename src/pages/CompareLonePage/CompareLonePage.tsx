...
const CompareLoanPage = () => {
  ...
  const handleFetchEligibleLoans = async (amount: number, tenure: number) => {
    try {
      ...
      const banks = resp.data.banks.map((bank: any) => ({
        ...
        trueAPR: bank.interestRate,
        tenureOptions: bank.tenureOptions || "12-84 months",
        processingFeeMin: bank.processingFeeMin,
        processingFeeMax: bank.processingFeeMax,
        approvalProbability: bank.approvalProbability,
        disbursalTime: bank.disbursalTime,
        pros: [
          "Fastest approval",
  ...
  const filteredLenders =
    comparisonTab === "customize" && customAmount
      ? lenders.filter((l) => l.maxSanctionAmount >= Number(customAmount))
      : lenders;
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                  ...
                  {comparisonTab === "customize" && (
                    <div className="flex items-center gap-3 w-full md:w-auto animate-in slide-in-from-right-4 duration-300">
                      ...
                      <div className="text-sm font-medium text-purple-600 bg-purple-50 px-3 py-2 rounded-lg border border-purple-100">
