          ...
          <div className="w-full max-w-md bg-white/70 backdrop-blur-xl rounded-2xl shadow-2xl p-7">
            ...
            {step === "OTP" && (
              <>
                ...
                <button className="w-full bg-gradient-to-r from-[#7C3AED] to-[#4F46E5] text-white rounded-lg py-3 font-semibold shadow-md hover:opacity-95 transition" onClick={()=> navigate('/loan-application')}>
                  Verify & Continue
                </button>
