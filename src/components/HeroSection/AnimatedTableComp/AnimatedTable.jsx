...
export default function AnimatedTable() {
  ...
  return (
    <div className="absolute top-[10%] right-[-5%] bottom-0 rounded-2xl shadow-lg border-transparent overflow-hidden group w-[53%] h-[120%] max-w-3xl mx-auto backdrop-blur-md bg-gradient-to-br from-black via-neutral-900 to-zinc-800 shadow-white shadow-2xl bg-transparent shadow-[0_0_6px_#ffd700,0_0_12px_#ffbf00,0_0_24px_#ffaa00] gold-glow">
