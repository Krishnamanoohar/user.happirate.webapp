...
export const PreSanctionLetter = ({
  ...
  const netDisbursalAmount =
    estimatedAmount - processingFeeAmount - insuranceAmount - thirdPartyCharges;
    ...
    <div className="animate-slide-up max-w-4xl mx-auto pb-8 mt-10">
        ...
        <CardContent className="p-6 md:p-8 space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-secondary/50 rounded-xl p-4 border border-border">
                ...
                <p className="font-bold text-lg text-green-600">
                  {lender?.prepaymentCharges === 0
                    ? "Nil"
                    : lender.prepaymentCharges !== undefined
          ...
          <div className="bg-gradient-to-br from-navy/5 to-transparent rounded-2xl p-6 border-2 border-navy/10">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center py-2 border-b border-dashed border-navy/10">
                  ...
                  <span className="font-bold">
                    ₹{totalCostOfCredit.toLocaleString("en-IN")}
                  </span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-dashed border-navy/10">
                  <span className="text-sm text-muted-foreground">
                  ...
                  <span className="font-medium">
                    ₹{processingFeeAmount.toLocaleString("en-IN")}
                  </span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-dashed border-navy/10">
                  <span className="text-sm text-muted-foreground">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center py-2 border-b border-dashed border-navy/10">
                  <span className="text-sm text-muted-foreground">
                    Third-Party/Verification Charges
                  </span>
                  <span className="font-medium">
                    ₹{thirdPartyCharges.toLocaleString("en-IN")}
                  </span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-dashed border-navy/10">
                  <span className="text-sm text-muted-foreground">
                  ...
                  <span className="font-bold text-green-600">
                    ₹{netDisbursalAmount.toLocaleString("en-IN")}
                  </span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-dashed border-navy/10">
                  <span className="text-sm text-muted-foreground">
            ...
            <div className="mt-4 p-3 bg-gray-200 rounded-lg border border-navy/10">
              <p className="text-sm font-semibold text-navy">
                ...
                Total cost of credit includes interest, processing fees,
                insurance charges, and any third-party charges.
              </p>
            </div>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-amber-700 dark:text-amber-400 mb-4">
                  As per RBI guidelines, borrowers shall have a{" "}
                  <strong>7-day cooling-off period</strong> to exit the loan by
                  repaying principal plus proportionate APR without penalty.
                </p>
                <Button
                  variant="outline"
          ...
          <div className="bg-secondary/30 rounded-xl p-5 border border-border">
            ...
            <ul className="text-sm space-y-2 text-muted-foreground">
              ...
              <li className="flex items-start gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-muted-foreground mt-2 flex-shrink-0" />
                APR and KFS values are estimated and subject to final
                confirmation
              </li>
              <li className="flex items-start gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-muted-foreground mt-2 flex-shrink-0" />
              ...
              <li className="flex items-start gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-muted-foreground mt-2 flex-shrink-0" />
                Borrowers shall have a 7-day cooling-off period to exit the loan
      ...
      <div className="text-center mt-6">
        ...
        <p className="text-xs text-muted-foreground max-w-md mx-auto">
          This is an estimated pre-sanction letter for informational purposes
          only. Actual loan approval is subject to verification and lender's
          discretion.
        </p>
      </div>
        ...
        >
          <DialogHeader className="text-center">
            ...
            <DialogDescription className="text-center text-base pt-2">
              Your loan has been provisionally sanctioned and is now moving to
              the
      ...
      <Dialog open={showReassessDialog} onOpenChange={setShowReassessDialog}>
        ...
        >
          <DialogHeader className="text-center">
            ...
            <DialogDescription className="text-center text-base pt-2">
              We'll save your application progress securely. You can return
              anytime within the next
              <strong className="text-foreground"> 7 days</strong> to continue
          ...
          <div className="bg-gray-50 rounded-xl p-4 mt-4 space-y-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-muted-foreground">
                After 7 days, your application will be automatically deleted for
                security
              </p>
            </div>
          </div>
