  ...
  return (
    ...
    <div className="animate-fade-in" ref={contentRef}>
      ...
      <div className="flex items-start justify-between mb-4">
        <div>
          <h5 style={{ fontFamily: "Denton" }} className="!text-[35px] !font-bold text-gray-950 mb-0.5">
            PROVISIONAL OFFER LETTER
          </h5>

          <p style={{ fontFamily: "sans-serif" }} className="text-md text-gray-500 mt-1">
      ...
      <div className="border-t border-border pt-6">
        ...
        {/* Eligible Offers */}
        <div className="mb-6">
          <h2 style={{ fontFamily: "Denton" }} className="font-display !text-[25px] !font-bold text-gray-950 mb-2">
