    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <Card className="rounded-3xl shadow-xl shadow-indigo-200/50 border-0 p-6 lg:p-8">
              <CardContent className="overflow-hidden">
                ...
                <div className="mb-8">
                  ...
                  <Slider
                    value={loanAmount}
                    onChange={(_, value) => setLoanAmount(Array.isArray(value) ? value[0] : value)}
                    min={100000}
                    max={10000000}
                    step={50000}
                    className="mb-2"
                ...
                <div className="mb-8">
                  ...
                  <Slider
                    value={interestRate}
                    onChange={(_, value) => setInterestRate(Array.isArray(value) ? value[0] : value)}
                    min={5}
                    max={20}
                    step={0.1}
                    className="mb-2"
                ...
                <div className="mb-8">
                  ...
                  <Slider
                    value={tenure}
                    onChange={(_, value) => setTenure(Array.isArray(value) ? value[0] : value)}
                    min={1}
                    max={30}
                    step={1}
                    className="mb-2"
